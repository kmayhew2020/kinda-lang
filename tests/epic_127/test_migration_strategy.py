            ...
            mock_validation.return_value = {
                'validation_phases': [
                    ...
                    },
                    {
                        ...
                        'criteria': ['All tests pass', 'Performance within limits', 'Integrations work']
                    }
                ],
                'success_criteria': {
                    'test_pass_rate': 0.95,
...
class TestMigrationStrategyIntegration:
    ...
    def test_complete_migration_strategy_workflow(self):
        ...
        with patch.object(self.strategy, 'analyze_project_requirements') as mock_analyze, \
    ...
    def test_migration_strategy_adaptation(self):
        ...
        with patch.object(self.strategy, 'adapt_strategy_based_on_feedback') as mock_adapt:
            ...
            if hasattr(self.strategy, 'adapt_strategy_based_on_feedback'):
                adaptation = self.strategy.adapt_strategy_based_on_feedback(initial_plan, runtime_feedback)
