...
"""
        ...
        with patch.object(self.utilities, "suggest_migration_points") as mock_method:
            mock_method.return_value = [
                {"line": 5, "pattern": "kinda_float", "code": "threshold = 2.5", "confidence": 0.8},
                {
                    "line": 7,
                    "pattern": "sometimes",
    ...
    def test_estimate_migration_effort_various_scenarios(self):
        ...
        scenarios = [
            {"name": "simple_script", "code": "x = 10\nprint(x)", "expected_effort": "low"},
            {
        ...
        with patch.object(self.utilities, "estimate_migration_effort") as mock_method:
            for scenario in scenarios:
                mock_method.return_value = {
                    ...
                    "estimated_hours": (
                        2
                        if scenario["expected_effort"] == "low"
                        else 8 if scenario["expected_effort"] == "medium" else 20
                    ),
                    "risk_factors": [],
                    "dependencies": [],
                }
...
"""
        ...
        try:
            ...
            with patch.object(
                self.utilities, "analyze_file_migration_potential"
            ) as mock_file_method:
