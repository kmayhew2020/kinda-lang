    ...
    def test_chaos_multiplier_mapping(self):
        ...
        for level, (min_mult, max_mult) in expected_ranges.items():
            with self.subTest(level=level):
                ...
                self.assertGreaterEqual(multiplier, min_mult, 
                                      f"Level {level} multiplier {multiplier} below {min_mult}")
                self.assertLessEqual(multiplier, max_mult,
                                   f"Level {level} multiplier {multiplier} above {max_mult}")
...
class TestChaosLevelVarianceTolerances(unittest.TestCase):
    ...
    def test_ish_variance_chaos_levels(self):
        ...
        self.assertLess(variances[1], variances[10], 
                       "Level 1 variance should be less than level 10")
    ...
    def test_ish_tolerance_chaos_levels(self):
        ...
        self.assertLess(tolerances[1], tolerances[10],
                       "Level 1 tolerance should be less than level 10")
...
class TestChaosLevelBooleanUncertainty(unittest.TestCase):
    ...
    def test_bool_uncertainty_chaos_levels(self):
        ...
        self.assertLess(uncertainties[1], uncertainties[10],
                       "Level 1 uncertainty should be less than level 10")
...
class TestChaosLevelMoodIntegration(unittest.TestCase):
    ...
    def test_multiplicative_effect_mood_chaos(self):
        ...
        self.assertNotEqual(prob_chaotic_low, prob_chaotic_high, 
                          "Chaos level should affect chaotic mood")
