...
""")
    ...
    def test_directory_transform(self, tmp_path):
        ...
        (input_dir / "file2.py.knda").write_text("~sometimes (True) {\n    ~sorta print('hello');\n}")
    ...
    def test_runtime_generation(self, tmp_path):
        ...
        runtime_path = Path(__file__).parent.parent.parent / "kinda" / "langs" / "python" / "runtime" / "fuzzy.py"
    ...
    def test_complex_nested_file(self, tmp_path):
        ...
        knda_file.write_text("""# Complex test file
~kinda int counter = 0;
...
class TestTransformCLI:
    ...
    def test_cli_transform_single_file(self, tmp_path):
        ...
        result = subprocess.run([
            "python", "-m", "kinda", "transform", 
            str(knda_file), "--out", str(tmp_path / "output")
