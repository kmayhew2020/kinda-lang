...
class EnvironmentDetector:
        ...
        try:
            ...
            if os.path.exists("/proc/cpuinfo"):
                with open("/proc/cpuinfo", "r") as f:
                    ...
                    if any(
                        indicator in cpuinfo for indicator in ["vmware", "virtualbox", "kvm", "xen"]
                    ):
                        return True
    ...
    def _calculate_baseline_factor(
        self, cpu_cores: int, memory_gb: float, platform_family: str, virtualized: bool
    ) -> float:
    ...
    def _measure_resource_constraints(self) -> Dict[str, float]:
        ...
        try:
            ...
            return {"cpu_load": 0.5, "memory_pressure": 0.5, "io_wait": 0.1, "load_average": 1.0}
    ...
    def _calculate_performance_multiplier(
        self, ci_env: CIEnvironment, platform: PlatformProfile, constraints: Dict[str, float]
    ) -> float:
