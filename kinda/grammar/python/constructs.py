...
KindaPythonConstructs = {
    "kinda_int": {
        ...
        "body": (
            ...
            "                print(f\"💡 Expected a number but got {type(val).__name__}\")\n"
            "                return random.randint(0, 10)\n"
            "        fuzz = random.randint(-1, 1)\n"
            "        return int(val + fuzz)\n"
            "    except Exception as e:\n"
            "        print(f\"🤷 Kinda int got kinda confused: {e}\")\n"
            "        print(f\"💡 Just picking a random number instead\")\n"
            "        return random.randint(0, 10)"
        ),
    },
    "sorta_print": {
    ...
    "sometimes": {
        ...
        "body": (
            ...
            "    except Exception as e:\n"
            "        print(f\"🤷 Sometimes got confused: {e}\")\n"
            "        print(\"💡 Flipping a coin instead\")\n"
    ...
    "maybe": {
        ...
        "body": (
            ...
            "    except Exception as e:\n"
            "        print(f\"🤷 Maybe couldn't decide: {e}\")\n"
            "        print(\"💡 Defaulting to random choice\")\n"
            "        return random.choice([True, False])"
        ),
    },
    "fuzzy_reassign": {
        ...
        "body": (
            ...
            "                print(f\"💡 Expected a number but got {type(value).__name__}\")\n"
            "                return random.randint(0, 10)\n"
            "        fuzz = random.randint(-1, 1)\n"
            "        return int(value + fuzz)\n"
            "    except Exception as e:\n"
            "        print(f\"🤷 Fuzzy assignment kinda failed: {e}\")\n"
            "        print(f\"💡 Returning a random number because why not?\")\n"
            "        return random.randint(0, 10)"
        ),
    },
    "kinda_binary": {
        ...
        "body": (
            ...
            "            print(f\"💡 Normalizing: pos={pos_prob}, neg={neg_prob}, neutral={neutral_prob}\")\n"
            ...
            "            return 0\n"
            "    except Exception as e:\n"
            "        print(f\"🤷 Binary choice kinda broke: {e}\")\n"
            "        print(f\"💡 Defaulting to random choice between -1, 0, 1\")\n"
